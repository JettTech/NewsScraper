  ...
  function createPanel(article) {
    ...
    var panel = $(
      [
        ...
        "<img id='data-" + article.img + "' src= '" + article.img + "' width='200px'>",
        "</div>",
...
//=====================================
      ...
      //   "<div class='card'>",
      //   "<div class='card-image waves-effect waves-block waves-light'>",
      //   "<img id='data-" + article.img + "' class='activator' src= '" + article.img + ">",
      //   "</div>",
      //   "<div class='card-content'>",
      //   "<span id='" + article.title + "' class='card-title activator grey-text text-darken-4'>",
      //   "article.title",
      ...
      //   "<span id='ExpandArtTitle' class='card-title grey-text text-darken-4'>",
      //   "<h5>",
      //   "<strong>",
      //   article.title,
      //   "</strong>",
      ...
      //   "</h5>",
      //   "<p>",
      //   "Wish add your own note?  Click on the edit button to your right to create and share your own.",
      //   "</p>",
      //   "<p id='noteBoxTitle'>",
      //   "</p>",
      //   "<div id='bootboxNote' class='fixed-action-btn horizontal'>",
