...
// var models = require("../models/"); //the MODLE OBJECT!!
...
module.exports = {
    ...
    fetch: function(callback) { //FETCH >> should PREFORM A NEW SCRAPE (...and therefore needs to access the scape.js file and function)!!
    ...
    update: function(error, query, callbackFunc) { //UPDATE >> should RETRIEVE and MODIFY PRE-EXISTING DATA in the database/models for ALL MENTIONED data-itmes (and therefore needs to accwss the models directory/ article model in the Article.js file)!!    
        ...
        models.update({ _id: query._id }, { $set: query }, //set the updated FIELD DATA to be equal to any new DATA/VALUES we pass in on QUERY
            null,
            callbackFunc
        );
    },
